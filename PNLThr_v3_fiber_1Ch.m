...
for k=1:N
    ...
    %customizing NRZ Pulse Generator
    NRZGens(k).SetParameterValue('Rise time',riseTime);
    NRZGens(k).SetParameterValue('Fall time',fallTime);
...
InAmp.GetInputPort(1).Connect(Mods(1).GetOutputPort(1));
